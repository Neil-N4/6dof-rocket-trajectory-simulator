...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--duration", type=float, default=2200.0, help="Simulation duration in seconds")
...
def main() -> None:
    ...
    cfg = replace(build_default_config(root), dt_s=args.dt, sim_duration_s=args.duration)
    ...
    print(
        f"Max-Q (0-80 km): {result.max_q_under_80km_pa/1000.0:.2f} kPa at t={result.max_q_under_80km_time_s:.1f} s"
    )
    print(f"Max attitude error: {result.max_attitude_error_deg:.2f} deg")
